...
async def list_payments(
    ...
    return await svc.get_payments_by_trip(
        db,
        trip_id
    )
...
async def delete_payment(
    ...
    deleted = await svc.delete_payment(
        db,
        payment_id
    )
...
async def get_balances(
    ...
    return await svc.compute_balances(
        db,
        trip_id
    )
...
async def get_settlement_suggestions(
    ...
    return await svc.compute_settlements(
        db,
        trip_id
    )
...
async def create_refund(
    ...
    return await svc.create_refund(
        db,
        data
    )
...
async def list_refunds(
    ...
    return await svc.get_refunds_by_booking(
        db,
        booking_id
    )